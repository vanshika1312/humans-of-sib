...
export const HIRING_ACTIVITY_KIND_LABEL: Record<HiringActivityKind, string> = {
  ...
  JOB_RESTORED: "Job restored as open in hiring",
  ...
  APPLICATION_INTERVIEW_NOTES_SAVED: "Interview notes saved",
  APPLICATION_ASSESSMENT_SUBMITTED: "Personality assessment submitted",
